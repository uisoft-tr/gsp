# Generated by Django 4.2.7 on 2025-06-25 21:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ocak', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)], verbose_name='Ocak Katsayısı')),
                ('subat', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)], verbose_name='Şubat Katsayısı')),
                ('mart', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)], verbose_name='Mart Katsayısı')),
                ('nisan', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)], verbose_name='Nisan Katsayısı')),
                ('mayis', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)], verbose_name='Mayıs Katsayısı')),
                ('haziran', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)], verbose_name='Haziran Katsayısı')),
                ('temmuz', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)], verbose_name='Temmuz Katsayısı')),
                ('agustos', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)], verbose_name='Ağustos Katsayısı')),
                ('eylul', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)], verbose_name='Eylül Katsayısı')),
                ('ekim', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)], verbose_name='Ekim Katsayısı')),
                ('kasim', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)], verbose_name='Kasım Katsayısı')),
                ('aralik', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)], verbose_name='Aralık Katsayısı')),
                ('olusturma_tarihi', models.DateTimeField(auto_now_add=True, verbose_name='Oluşturma Tarihi')),
                ('kategori', models.ManyToManyField(blank=True, related_name='urunler', to='sulama.urunkategorisi', verbose_name='Kategoriler')),
                ('sulama', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='urunler', to='sulama.sulama', verbose_name='Sulama Sistemi')),
            ],
            options={
                'verbose_name': 'Ürün',
        ...
        migrations.AddField(
            ...
            name='sulama',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='depolama_tesisleri', to='sulama.sulama', verbose_name='Sulama Sistemi'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alan', models.FloatField(validators=[django.core.validators.MinValueValidator(0)], verbose_name='Alan (m²)')),
                ...
                ('olusturma_tarihi', models.DateTimeField(auto_now_add=True, verbose_name='Oluşturma Tarihi')),
                ('sulama', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='yillik_genel_su_tuketimi', to='sulama.sulama', verbose_name='Sulama Sistemi')),
                ('urun', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='yillik_genel_su_tuketimi', to='sulama.urun', verbose_name='Ürün')),
            ],
            options={
                'verbose_name': 'Yıllık Genel Su Tüketimi',
                'verbose_name_plural': 'Yıllık Genel Su Tüketimi',
                'ordering': ['-yil', 'sulama__bolge__isim', 'urun__isim'],
                'unique_together': {('yil', 'sulama', 'urun')},
            },
        ),
        migrations.CreateModel(
            name='KanalAbak',
